...
import { Schema  } from './schema-edit/lib/schema';
// import '../app/shared/service/service.js'
// import { CustomComponent } from './custom.component';
import { ActivatedRoute } from '@angular/router';



import { JsonSchemaFormService } from './schema-edit/lib/json-schema-form.service';
import { avroToJSONSchema } from 'avro-to-json-schema';


declare var getSchema:any;
// new getSchema();
// function getSchema(){
//   const schemaText = fs.readFileSync("example.avsc", "UTF8");
// const schema = JSON.parse(schemaText) ;
// alert(avroToJSONSchema(schema ));
// }
...
@Component({
  selector: 'app-root',
  template: '  <input type="file" (change)="fileChanged($event)"> <router-outlet></router-outlet> <app-schema-edit [schema]="schema"></app-schema-edit>'
})
  ...
  schema;
   ...
   uploadDocument(file) {
    ...
    fileReader.onload = (e) => {
      ...
      console.log("avneet",this.schema );
    }
